...
const markdownComponents: Components = {
  h1: (props) => <h1 className="mb-6 mt-12 text-4xl font-semibold text-[#003366]" {...props} />,

  h2: (props) => <h2 className="mb-4 mt-12 text-3xl font-semibold text-[#003366]" {...props} />,

  h3: (props) => <h3 className="mb-3 mt-8 text-2xl font-semibold text-[#003366]" {...props} />,

  h4: (props) => <h4 className="mb-3 mt-6 text-xl font-semibold text-[#003366]" {...props} />,
  ...
  ul: (props) => <ul className="mb-6 list-inside list-disc space-y-2 text-[#0B0C0C]" {...props} />,

  ol: (props) => (
    <ol className="mb-6 list-inside list-decimal space-y-2 text-[#0B0C0C]" {...props} />
  ),

  li: (props) => <li className="break-words leading-relaxed [overflow-wrap:anywhere]" {...props} />,

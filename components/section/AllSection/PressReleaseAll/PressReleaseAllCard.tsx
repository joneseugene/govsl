...
export function PressReleaseAllCard({ release }: PressReleaseAllCardProps) {
  ...
  return (
    <article className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-gray-300 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
      {/* Meta */}
      <div className="mb-3 flex flex-wrap items-center gap-3 text-sm">
        <span className="font-medium text-gray-800">{release.mdas?.name}</span>
